...
/* harmony import */ var _components_phone_catalog_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13);
/* harmony import */ var _components_phone_viewer_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
/* harmony import */ var _components_filter_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(18);
/* harmony import */ var _components_shopping_cart_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(19);
/* harmony import */ var _phone_service_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(20);
/* harmony import */ var _Component_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(16);
...
var PhonesPage = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(PhonesPage, _Component);

  var _super = _createSuper(PhonesPage);
  ...
  function PhonesPage(_ref) {
    ...
    _this._initPhoneCatalog();

    _this._initPhoneViewer();
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(PhonesPage, [{
    key: "_showPhones",
    value: function () {
      var _showPhones2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var filteredData, allPhones;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                filteredData = this._filter.getCurrentData();
                _context.next = 3;
                return _phone_service_js__WEBPACK_IMPORTED_MODULE_11__["default"].getAll(filteredData);

              case 3:
                allPhones = _context.sent;
    ...
    key: "_initPhoneCatalog",
    value: function _initPhoneCatalog() {
      var _this2 = this;

      this._catalog = new _components_phone_catalog_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
        element: this._element.querySelector('[data-component="phone-catalog"]')
      });

      this._catalog.subscribe('phoneSelected', /*#__PURE__*/function () {
        var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(phoneId) {
          var phone;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 3;
                  return _phone_service_js__WEBPACK_IMPORTED_MODULE_11__["default"].getById(phoneId);

                case 3:
                  phone = _context2.sent;

                  _this2._viewer.show(phone);
      ...
      this._catalog.subscribe('addToBasket', function (phoneId) {
        _this2._cart.add(phoneId);
      });
    }
  }, {
    key: "_initPhoneViewer",
    value: function _initPhoneViewer() {
      var _this3 = this;

      this._viewer = new _components_phone_viewer_js__WEBPACK_IMPORTED_MODULE_8__["default"]({
        element: this._element.querySelector('[data-component="phone-viewer"]')
      });

      this._viewer.subscribe('addToBasket', function (phoneId) {
        _this3._cart.add(phoneId);
      });

      this._viewer.subscribe('back', /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
    ...
    value: function _initCart() {
      ...
      this._cart = new _components_shopping_cart_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
        element: this._element.querySelector('[data-component="shopping-cart"]')
      });

      this._cart.subscribe('removePhone', function (id) {
        _this4._cart.remove(id);
      });
    }
  }, {
    key: "_initFilter",
    value: function _initFilter() {
      ...
      this._filter = new _components_filter_js__WEBPACK_IMPORTED_MODULE_9__["default"]({
        element: this._element.querySelector('[data-component="filter"]')
      });

      this._filter.subscribe('queryChanged', /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this5._showPhones();
      ...
      this._filter.subscribe('orderChanged', /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5() {
  ...
  return PhonesPage;
}(_Component_js__WEBPACK_IMPORTED_MODULE_12__["default"]);
...
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
...
var PhoneCatalog = /*#__PURE__*/function (_Component) {
  ...
  function PhoneCatalog(_ref) {
    ...
    _this.on('click', 'phone', function (event) {
      var phone = event.target.closest('[data-element="phone"]');

      _this.emit('phoneSelected', phone.dataset.phoneId);
    });

    _this.on('click', 'add-button', function (event) {
      var phone = event.target.closest('[data-element="phone"]');

      _this.emit('addToBasket', phone.dataset.phoneId);
    });
...
var Component = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Component, [{
    ...
    value: function emit(eventName, data) {
      var arrOfCallbacks = this._callbackMap[eventName] || [];
      arrOfCallbacks.forEach(function (callback) {
        callback(data);
      });
    }
  }, {
    ...
    value: function on(eventName, elementName, callback) {
      this._element.addEventListener(eventName, function (event) {
        var targetElement = event.target.closest("[data-element=\"".concat(elementName, "\"]"));
...
var PhoneViewer = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PhoneViewer, [{
    ...
    value: function show(phoneDetails) {
      ...
      this.on('click', 'back-button', function () {
        _this.emit('back', null);
      });
      this.on('click', 'add-button', function () {
        _this.emit('addToBasket', _this._phoneDetails.id);
      });
      this.on('click', 'small-image', function (event) {
...
var Filter = /*#__PURE__*/function (_Component) {
  ...
  function Filter(_ref) {
    ...
    var emitQueryChangedWithDebounce = _.debounce(function (event) {
      _this.emit('queryChanged', event.target.value);
    }, 500);

    _this.on('input', 'query-field', emitQueryChangedWithDebounce);

    _this.on('change', 'order-field', function (event) {
      _this.emit('orderChanged', event.target.value);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Filter, [{
    ...
    value: function getCurrentData() {
      ...
      var queryFiled = this._element.querySelector('[data-element="query-field"]');
...
var ShoppingCart = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(ShoppingCart, _Component);
  ...
  function ShoppingCart(_ref) {
    ...
    _this.on('click', 'remove-button', function (event) {
      var idToRemove = event.target.dataset.itemId;

      _this.emit('removePhone', idToRemove);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ShoppingCart, [{
    ...
    key: "remove",
    value: function remove(phoneId) {
      this._items = this._items.filter(function (itemId) {
        return itemId !== phoneId;
      });
    ...
    key: "_render",
    value: function _render() {
      this._element.innerHTML = "\n          <p>Shopping Cart</p>\n          <ul>\n            ".concat(this._items.map(function (itemId) {
...
var PhoneService = {
  _getPhones: function _getPhones(url) {
  ...
  getAll: function getAll() {
    ...
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
      var _ref, _ref$query, query, _ref$orderBy, orderBy, phones, filteredPhones;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _ref = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : {}, _ref$query = _ref.query, query = _ref$query === void 0 ? '' : _ref$query, _ref$orderBy = _ref.orderBy, orderBy = _ref$orderBy === void 0 ? 'age' : _ref$orderBy;
              _context2.next = 3;
              return _this._getPhones('https://raw.githubusercontent.com/JuliaKirschenheuter/JS-Project/master/phones/phones.json');

            case 3:
              phones = _context2.sent;
              filteredPhones = _this._filter(phones, query);
              return _context2.abrupt("return", _this._sort(filteredPhones, orderBy));
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _this2._getPhones("https://raw.githubusercontent.com/JuliaKirschenheuter/JS-Project/master/phones/".concat(phoneId, ".json"));
